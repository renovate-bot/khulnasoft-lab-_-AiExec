...
export declare class AiexecClient {
...
export declare class CompletionClient extends AiexecClient {
...
export declare class ChatClient extends AiexecClient {
  createChatMessage(
    inputs: any,
    query: string,
    user: User,
...
export declare class WorkflowClient extends AiexecClient {
