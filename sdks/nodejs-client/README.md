# Aiexec Node.js SDK
This is the Node.js SDK for the Aiexec API, which allows you to easily integrate Aiexec into your Node.js applications.

## Install
```bash
npm install aiexec-client
```
...
```js
import { AiexecClient, ChatClient, CompletionClient } from 'aiexec-client'
...
const client = new AiexecClient(API_KEY)
...
Replace 'your-api-key-here' with your actual Aiexec API key.Replace 'your-app-id-here' with your actual Aiexec APP ID.
