...
export const BASE_URL = "https://api.aiexec.ai/v1";
...
export class CompletionClient extends AiexecClient {
...
export class ChatClient extends AiexecClient {
  createChatMessage(
    inputs,
    query,
    user,
...
export class WorkflowClient extends AiexecClient {
