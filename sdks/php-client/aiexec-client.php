...
class AiexecClient {
    ...
    public function __construct($api_key, $base_url = null) {
        ...
        $this->base_url = $base_url ?? 'https://api.aiexec.ai/v1/';
...
class CompletionClient extends AiexecClient {
...
class ChatClient extends AiexecClient {
...
class WorkflowClient extends AiexecClient{
