const translation = {
  ...
  stepOne: {
    ...
    website: {
      ...
      watercrawlDocLink: 'https://docs.aiexec.ai/en/guides/knowledge-base/create-knowledge-and-upload-documents/import-content-data/sync-from-website',
  ...
  otherDataSource: {
    ...
    description: 'Obecnie baza wiedzy Aiexec ma tylko ograniczone źródła danych. Dodanie źródła danych do bazy wiedzy Aiexec to fantastyczny sposób na zwiększenie elastyczności i możliwości platformy dla wszystkich użytkowników. Nasz przewodnik po wkładach ułatwia rozpoczęcie pracy. Kliknij poniższy link, aby dowiedzieć się więcej.',
  },
  watercrawl: {
