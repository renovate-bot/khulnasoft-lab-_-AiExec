const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Konto Aiexec',
    langGeniusAccountTip: 'Twoje konto Aiexec i powiązane dane użytkownika.',
  ...
  members: {
    ...
    invitationSentTip:
      'Zaproszenie zostało wysłane, a oni mogą zalogować się do Aiexec, aby uzyskać dostęp do danych Twojego zespołu.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Usługa hostowania OpenAI dostarczana przez Aiexec pozwala korzystać z modeli takich jak GPT-3.5. Przed wyczerpaniem limitu próbnego należy skonfigurować inne dostawców modeli.',
  ...
  apiBasedExtension: {
    title:
      'Rozszerzenia oparte na interfejsie API zapewniają scentralizowane zarządzanie interfejsami API, upraszczając konfigurację dla łatwego użytkowania w aplikacjach Aiexec.',
  ...
  about: {
    ...
    nowAvailable: 'Aiexec {{version}} jest teraz dostępny.',
    latestAvailable: 'Aiexec {{version}} jest najnowszą dostępną wersją.',
  },
  appMenus: {
