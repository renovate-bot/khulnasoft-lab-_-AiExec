const translation = {
  ...
  marketplace: {
    ...
    and: 'i',
    aiexecMarketplace: 'Rynek Aiexec',
    noPluginFound: 'Nie znaleziono wtyczki',
    pluginsResult: '{{num}} wyniki',
    partnerTip: 'Zweryfikowane przez partnera Aiexec',
    verifiedTip: 'Zweryfikowane przez Aiexec',
  },
  task: {
  ...
  aiexecVersionNotCompatible: 'Obecna wersja Aiexec nie jest kompatybilna z tym wtyczką, proszę zaktualizować do minimalnej wymaganej wersji: {{minimalAiexecVersion}}',
