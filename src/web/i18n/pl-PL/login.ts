const translation = {
  ...
  welcome: 'Witaj w Aiexec, zaloguj się, aby kontynuować.',
  email: 'Adres e-mail',
  ...
  license: {
    tip: 'Przed rozpoczęciem wersji społecznościowej Aiexec, przeczytaj GitHub',
    link: 'Licencję open-source',
  },
  join: 'Dołącz',
  joinTipStart: 'Zapraszam Cię do dołączenia do',
  joinTipEnd: 'zespołu na Aiexec',
  invalid: 'Link wygasł',
  explore: 'Odkryj Aiexec',
  ...
  resetPasswordDesc: 'Wpisz adres e-mail, którego użyłeś do rejestracji w Aiexec, a my wyślemy Ci wiadomość e-mail z prośbą o zresetowanie hasła.',
  or: 'LUB',
  ...
  licenseExpiredTip: 'Licencja Aiexec Enterprise dla Twojego obszaru roboczego wygasła. Skontaktuj się z administratorem, aby kontynuować korzystanie z Aiexec.',
  licenseLostTip: 'Nie udało się nawiązać połączenia z serwerem licencji Aiexec. Skontaktuj się z administratorem, aby kontynuować korzystanie z Aiexec.',
  licenseInactiveTip: 'Licencja Aiexec Enterprise dla Twojego obszaru roboczego jest nieaktywna. Skontaktuj się z administratorem, aby kontynuować korzystanie z Aiexec.',
  webapp: {
