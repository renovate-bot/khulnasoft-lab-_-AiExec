const translation = {
  ...
  intro1: 'Wiedzę można zintegrować z aplikacją Aiexec ',
  ...
  externalAPIPanelDescription: 'Interfejs API wiedzy zewnętrznej służy do łączenia się z bazą wiedzy poza Aiexec i pobierania wiedzy z tej bazy wiedzy.',
  chunkingMode: {
