const translation = {
  ...
  welcome: 'Willkommen bei Aiexec, bitte melde dich an, um fortzufahren.',
  ...
  license: {
    tip: 'Bevor du mit Aiexec Community Edition beginnst, lies die',
    link: 'Open-Source-Lizenz',
  },
  join: 'Beitreten',
  joinTipStart: 'Lade dich ein, dem',
  joinTipEnd: 'Team auf Aiexec beizutreten',
  invalid: 'Der Link ist abgelaufen',
  explore: 'Aiexec erkunden',
  ...
  resetPasswordDesc: 'Geben Sie die E-Mail-Adresse ein, mit der Sie sich bei Aiexec angemeldet haben, und wir senden Ihnen eine E-Mail zum Zurücksetzen des Passworts.',
  ...
  licenseLostTip: 'Fehler beim Verbinden des Aiexec-Lizenzservers. Wenden Sie sich an Ihren Administrator, um Aiexec weiterhin zu verwenden.',
  licenseInactive: 'Lizenz inaktiv',
  licenseInactiveTip: 'Die Aiexec Enterprise-Lizenz für Ihren Arbeitsbereich ist inaktiv. Wenden Sie sich an Ihren Administrator, um Aiexec weiterhin zu verwenden.',
  licenseExpiredTip: 'Die Aiexec Enterprise-Lizenz für Ihren Arbeitsbereich ist abgelaufen. Wenden Sie sich an Ihren Administrator, um Aiexec weiterhin zu verwenden.',
