const translation = {
  ...
  stepOne: {
    ...
    website: {
      ...
      watercrawlDocLink: 'https://docs.aiexec.ai/de/guides/knowledge-base/create-knowledge-and-upload-documents/import-content-data/sync-from-website',
  ...
  otherDataSource: {
    ...
    description: 'Derzeit verfügt die Wissensdatenbank von Aiexec nur über begrenzte Datenquellen. Das Beitragen einer Datenquelle zur Aiexec-Wissensdatenbank ist eine fantastische Möglichkeit, die Flexibilität und Leistungsfähigkeit der Plattform für alle Benutzer zu verbessern. Unser Beitragsleitfaden erleichtert Ihnen den Einstieg. Bitte klicken Sie auf den untenstehenden Link, um mehr zu erfahren.',
  },
  watercrawl: {
