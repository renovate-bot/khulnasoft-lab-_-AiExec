const translation = {
  ...
  marketplace: {
    ...
    aiexecMarketplace: 'Aiexec Marktplatz',
    moreFrom: 'Mehr aus dem Marketplace',
    pluginsResult: '{{num}} Ergebnisse',
    empower: 'Unterstützen Sie Ihre KI-Entwicklung',
    and: 'und',
    partnerTip: 'Von einem Aiexec-Partner verifiziert',
    verifiedTip: 'Von Aiexec überprüft',
  },
  task: {
  ...
  aiexecVersionNotCompatible: 'Die aktuelle Aiexec-Version ist mit diesem Plugin nicht kompatibel, bitte aktualisieren Sie auf die erforderliche Mindestversion: {{minimalAiexecVersion}}',
