const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Aiexec-Konto',
    langGeniusAccountTip: 'Ihr Aiexec-Konto und zugehörige Benutzerdaten.',
  ...
  members: {
    ...
    invitationSentTip: 'Einladung gesendet, und sie können sich bei Aiexec anmelden, um auf Ihre Teamdaten zuzugreifen.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Der OpenAI-Hostingdienst von Aiexec ermöglicht es Ihnen, Modelle wie GPT-3.5 zu verwenden. Bevor Ihr Probe-Kontingent aufgebraucht ist, müssen Sie andere Modellanbieter einrichten.',
  ...
  apiBasedExtension: {
    title: 'API-Erweiterungen bieten zentralisiertes API-Management und vereinfachen die Konfiguration für eine einfache Verwendung in Aiexecs Anwendungen.',
  ...
  about: {
    ...
    nowAvailable: 'Aiexec {{version}} ist jetzt verfügbar.',
    latestAvailable: 'Aiexec {{version}} ist die neueste verfügbare Version.',
  },
  appMenus: {
    overview: 'Übersicht',
