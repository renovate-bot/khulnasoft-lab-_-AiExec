const translation = {
  ...
  marketplace: {
    ...
    discover: 'Descubrir',
    and: 'y',
    aiexecMarketplace: 'Mercado de Aiexec',
    verifiedTip: 'Verificado por Aiexec',
    partnerTip: 'Verificado por un socio de Aiexec',
  },
  task: {
  ...
  aiexecVersionNotCompatible: 'La versión actual de Aiexec no es compatible con este plugin, por favor actualiza a la versión mínima requerida: {{minimalAiexecVersion}}',
