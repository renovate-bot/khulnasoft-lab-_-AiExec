const translation = {
  ...
  stepOne: {
    ...
    website: {
      ...
      watercrawlDocLink: 'https://docs.aiexec.ai/ja/guides/knowledge-base/create-knowledge-and-upload-documents/import-content-data/sync-from-website',
    },
  },
  stepTwo: {
    segmentation: 'チャンク設定',
  ...
  otherDataSource: {
    ...
    description: '現在、Aiexec のナレッジベースには利用できるデータソースが限られています。Aiexec のナレッジベースにデータソースを提供いただくことは、プラットフォームの柔軟性と能力を向上させる上で非常に有益です。貢献ガイドをご用意していますので、ぜひご協力ください。詳細については、以下のリンクをクリックしてください。',
    learnMore: '詳細はこちら',
  },
  watercrawl: {
