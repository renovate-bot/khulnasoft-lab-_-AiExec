const translation = {
  ...
  marketplace: {
    ...
    discover: '探索',
    and: 'と',
    aiexecMarketplace: 'Aiexec マーケットプレイス',
    ...
    viewMore: 'もっと見る',
    verifiedTip: 'このプラグインは Aiexec によって認証されています',
    partnerTip: 'このプラグインは Aiexec のパートナーによって認証されています',
  },
  task: {
  ...
  aiexecVersionNotCompatible: '現在の Aiexec バージョンはこのプラグインと互換性がありません。最小バージョンは{{minimalAiexecVersion}}です。',
  metadata: {
    title: 'プラグイン',
  },
