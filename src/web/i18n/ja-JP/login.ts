const translation = {
  pageTitle: 'はじめましょう！👋',
  welcome: 'Aiexec へようこそ。続行するにはログインしてください。',
  email: 'メールアドレス',
  ...
  license: {
    tip: 'GitHub のオープンソースライセンスを確認してから、Aiexec Community Edition を開始してください。',
    link: 'オープンソースライセンス',
  },
  join: '参加する',
  ...
  resetPasswordDesc: 'Aiexec へのサインアップに使用したメールアドレスを入力すると、パスワードリセットメールが送信されます。',
  licenseLost: 'ライセンスを失った',
  licenseExpiredTip: 'ワークスペースの Aiexec Enterprise ライセンスの有効期限が切れています。Aiexec を引き続き使用するには、管理者に連絡してください。',
  licenseInactive: 'ライセンスが非アクティブです',
  licenseInactiveTip: 'ワークスペースの Aiexec Enterprise ライセンスが非アクティブです。Aiexec を引き続き使用するには、管理者に連絡してください。',
  licenseExpired: 'ライセンスの有効期限が切れています',
  licenseLostTip: 'Aiexec ライセンスサーバーへの接続に失敗しました。続けて Aiexec を使用するために管理者に連絡してください。',
  webapp: {
