const translation = {
  ...
  welcome: 'Bine ai venit la Aiexec, te rugăm să te autentifici pentru a continua.',
  ...
  or: 'SAU',
  resetPasswordDesc: 'Tastați e-mailul pe care l-ați folosit pentru a vă înscrie pe Aiexec și vă vom trimite un e-mail de resetare a parolei.',
  changePasswordBtn: 'Setați o parolă',
  licenseLostTip: 'Nu s-a reușit conectarea serverului de licențe Aiexec. Contactați administratorul pentru a continua să utilizați Aiexec.',
  licenseInactive: 'Licență inactivă',
  licenseInactiveTip: 'Licența Aiexec Enterprise pentru spațiul de lucru este inactivă. Contactați administratorul pentru a continua să utilizați Aiexec.',
  licenseExpired: 'Licență expirată',
  licenseLost: 'Licență pierdută',
  licenseExpiredTip: 'Licența Aiexec Enterprise pentru spațiul de lucru a expirat. Contactați administratorul pentru a continua să utilizați Aiexec.',
  webapp: {
