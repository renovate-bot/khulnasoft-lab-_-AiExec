const translation = {
  ...
  marketplace: {
    ...
    aiexecMarketplace: 'Piața Aiexec',
    moreFrom: 'Mai multe din Marketplace',
    and: 'și',
    viewMore: 'Vezi mai mult',
    partnerTip: 'Verificat de un partener Aiexec',
    verifiedTip: 'Verificat de Aiexec',
  },
  task: {
  ...
  aiexecVersionNotCompatible: 'Versiunea curentă Aiexec nu este compatibilă cu acest plugin, vă rugăm să faceți upgrade la versiunea minimă necesară: {{minimalAiexecVersion}}',
