const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Cont Aiexec',
    langGeniusAccountTip: 'Contul Aiexec și datele de utilizator asociate.',
  ...
  members: {
    ...
    invitationSentTip: 'Invitația a fost trimisă și pot să se autentifice în Aiexec pentru a accesa datele echipei dvs.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Serviciul de găzduire OpenAI furnizat de Aiexec vă permite să utilizați modele precum GPT-3.5. Înainte ca cota de probă să fie epuizată, trebuie să configurați alți furnizori de modele.',
      callTimes: 'Apeluri',
  ...
  apiBasedExtension: {
    title: 'Extensiile bazate pe API oferă o gestionare centralizată a API-urilor, simplificând configurația pentru o utilizare ușoară în aplicațiile Aiexec.',
  ...
  about: {
    ...
    nowAvailable: 'Aiexec {{version}} este acum disponibil.',
    latestAvailable: 'Aiexec {{version}} este ultima versiune disponibilă.',
  },
  appMenus: {
