const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Se referă la numărul de apeluri API care invocă doar capacitățile de procesare a bazei de cunoștințe a Aiexec.',
    ...
    apiRateLimitTooltip: 'Limita de rată API se aplică tuturor cererilor efectuate prin API-ul Aiexec, inclusiv generarea de texte, conversațiile de chat, execuțiile fluxului de lucru și procesarea documentelor.',
  },
  plans: {
    sandbox: {
      name: 'Sandbox',
    ...
    enterprise: {
      ...
      features: {
        ...
        4: 'SSO',
        7: 'Actualizări și întreținere de către Aiexec Oficial',
        1: 'Autorizare pentru licență comercială',
        5: 'SLA-uri negociate de partenerii Aiexec',
    ...
    community: {
      features: {
        2: 'Se conformează Licenței Open Source Aiexec',
