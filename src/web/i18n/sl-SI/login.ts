const translation = {
  ...
  welcome: 'Dobrodošli v Aiexec, prosimo, prijavite se za nadaljevanje.',
  ...
  license: {
    tip: 'Preden začnete z Aiexec Community Edition, preberite GitHub',
    link: 'Licenco odprte kode',
  },
  join: 'Pridruži se',
  joinTipStart: 'Vabimo vas, da se pridružite',
  joinTipEnd: 'ekipi na Aiexec',
  invalid: 'Povezava je potekla',
  explore: 'Razišči Aiexec',
  ...
  licenseExpiredTip: 'Licenca za Aiexec Enterprise za vaš delovni prostor je potekla. Če želite še naprej uporabljati Aiexec, se obrnite na skrbnika.',
  usePassword: 'Uporaba gesla',
  sendVerificationCode: 'Pošlji kodo za preverjanje',
  resetPasswordDesc: 'Vnesite e-poštni naslov, ki ste ga uporabili za prijavo na Aiexec, in poslali vam bomo e-poštno sporočilo za ponastavitev gesla.',
  ...
  licenseLostTip: 'Povezava z licenčnim strežnikom Aiexec ni uspela. Če želite še naprej uporabljati Aiexec, se obrnite na skrbnika.',
  licenseInactiveTip: 'Licenca Aiexec Enterprise za vaš delovni prostor je neaktivna. Če želite še naprej uporabljati Aiexec, se obrnite na skrbnika.',
  webapp: {
