const translation = {
  ...
  marketplace: {
    ...
    sortBy: 'Razvrsti po',
    verifiedTip: 'Verificirano s strani Aiexec',
    discover: 'Odkrijte',
    partnerTip: 'Potrjeno s strani partnerja Aiexec',
    ...
    aiexecMarketplace: 'Aiexec Marketplace',
  },
  task: {
  ...
  aiexecVersionNotCompatible: 'Trenutna različica Aiexec ni združljiva s to vtičnico, prosimo, posodobite na minimalno zahtevano različico: {{minimalAiexecVersion}}',
