const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Aiexec račun',
    langGeniusAccountTip: 'Vaš Aiexec račun in povezani uporabniški podatki.',
    editName: 'Uredi ime',
  ...
  members: {
    ...
    invitationSentTip: 'Povabilo poslano, in po prijavi v Aiexec bodo imeli dostop do vaših podatkov ekipe.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Gostitvena storitev OpenAI, ki jo ponuja Aiexec, vam omogoča uporabo modelov, kot je GPT-3.5. Preden porabite kvoto za preizkus, morate nastaviti druge ponudnike modelov.',
  ...
  modelProvider: {
    ...
    apiBasedExtension: {
      title: 'Razširitve API omogočajo centralizirano upravljanje API, kar poenostavi konfiguracijo za enostavno uporabo v aplikacijah Aiexec.',
      link: 'Naučite se, kako razviti svojo API razširitev.',
      linkUrl: 'https://docs.aiexec.ai/en/guides/extension/api-based-extension/README',
    ...
    about: {
      ...
      nowAvailable: 'Aiexec {{version}} je zdaj na voljo.',
      latestAvailable: 'Aiexec {{version}} je najnovejša različica na voljo.',
    },
    appMenus: {
      overview: 'Nadzor',
  ...
  apiBasedExtension: {
    ...
    title: 'Razširitve API zagotavljajo centralizirano upravljanje API, kar poenostavlja konfiguracijo za enostavno uporabo v aplikacijah Aiexec.',
    linkUrl: 'https://docs.aiexec.ai/en/guides/extension/api-based-extension/README',
  ...
  about: {
    updateNow: 'Posodobi zdaj',
    nowAvailable: 'Aiexec {{version}} je zdaj na voljo.',
    latestAvailable: 'Aiexec {{version}} je najnovejša različica, ki je na voljo.',
    changeLog: 'Dnevnik sprememb',
  },
  appMenus: {
