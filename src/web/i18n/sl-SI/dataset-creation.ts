const translation = {
  ...
  stepOne: {
    ...
    website: {
      ...
      watercrawlDocLink: 'https://docs.aiexec.ai/sl/guides/knowledge-base/create-knowledge-and-upload-documents/import-content-data/sync-from-website',
  ...
  otherDataSource: {
    ...
    description: 'Trenutno ima baza znanja Aiexec le omejene vire podatkov. Prispevanje vira podatkov v bazo znanja Aiexec je fantastičen način za izboljšanje prilagodljivosti in moči platforme za vse uporabnike. Naš vodnik za prispevke olajša začetek. Če želite izvedeti več, kliknite spodnjo povezavo.',
  },
  watercrawl: {
