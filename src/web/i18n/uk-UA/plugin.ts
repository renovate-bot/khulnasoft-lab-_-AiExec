const translation = {
  ...
  marketplace: {
    ...
    verifiedTip: 'Перевірено Aiexec',
    partnerTip: 'Перевірено партнером Aiexec',
  },
  task: {
  ...
  aiexecVersionNotCompatible: 'Поточна версія Aiexec не сумісна з цим плагіном, будь ласка, оновіть до мінімальної версії: {{minimalAiexecVersion}}',
