const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Відноситься до кількості викликів API, що викликають лише можливості обробки бази знань Aiexec.',
    ...
    apiRateLimitTooltip: 'Обмеження частоти запитів застосовується до всіх запитів, зроблених через API Aiexec, включаючи генерацію тексту, чат-розмови, виконання робочих процесів та обробку документів.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        5: 'Угоди про рівень обслуговування, узгоджені партнерами Aiexec',
        ...
        7: 'Оновлення та обслуговування від Aiexec Офіційно',
      },
    ...
    community: {
      features: {
        2: 'Відповідає ліцензії Aiexec Open Source',
