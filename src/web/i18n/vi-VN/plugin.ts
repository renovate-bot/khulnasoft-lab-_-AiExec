const translation = {
  ...
  marketplace: {
    ...
    viewMore: 'Xem thêm',
    aiexecMarketplace: 'Thị trường Aiexec',
    discover: 'Khám phá',
    ...
    and: 'và',
    verifiedTip: 'Được xác nhận bởi Aiexec',
    partnerTip: 'Được xác nhận bởi một đối tác của Aiexec',
  },
  task: {
  ...
  aiexecVersionNotCompatible: 'Phiên bản Aiexec hiện tại không tương thích với plugin này, vui lòng nâng cấp lên phiên bản tối thiểu cần thiết: {{minimalAiexecVersion}}',
