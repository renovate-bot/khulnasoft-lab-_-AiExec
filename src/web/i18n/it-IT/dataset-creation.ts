const translation = {
  ...
  stepOne: {
    ...
    website: {
      ...
      firecrawlDocLink:
        'https://docs.aiexec.ai/guides/knowledge-base/sync_from_website',
      options: 'Opzioni',
      ...
      watercrawlDocLink: 'https://docs.aiexec.ai/it/guides/knowledge-base/create-knowledge-and-upload-documents/import-content-data/sync-from-website',
    },
    cancel: 'Annulla',
  },
  stepTwo: {
  ...
  otherDataSource: {
    ...
    description: 'Attualmente, la knowledge base di Aiexec ha solo fonti di dati limitate. Contribuire con una fonte di dati alla knowledge base di Aiexec è un modo fantastico per migliorare la flessibilità e la potenza della piattaforma per tutti gli utenti. La nostra guida ai contributi ti aiuta a iniziare. Clicca sul link sottostante per saperne di più.',
  },
  watercrawl: {
