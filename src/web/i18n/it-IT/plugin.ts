const translation = {
  ...
  marketplace: {
    ...
    aiexecMarketplace: 'Mercato Aiexec',
    discover: 'Scoprire',
    ...
    verifiedTip: 'Verificato da Aiexec',
    partnerTip: 'Verificato da un partner Aiexec',
  },
  task: {
  ...
  aiexecVersionNotCompatible: 'L\'attuale versione di Aiexec non è compatibile con questo plugin, si prega di aggiornare alla versione minima richiesta: {{minimalAiexecVersion}}',
