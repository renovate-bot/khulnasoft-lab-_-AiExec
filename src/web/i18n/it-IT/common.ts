const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Account Aiexec',
    langGeniusAccountTip: 'Il tuo account Aiexec e i dati utente associati.',
  ...
  members: {
    ...
    invitationSentTip:
      'Invito inviato, e possono accedere a Aiexec per accedere ai dati del tuo team.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Il servizio di hosting OpenAI fornito da Aiexec ti consente di utilizzare modelli come GPT-3.5. Prima che la tua quota di prova sia esaurita, devi configurare altri fornitori di modelli.',
  ...
  apiBasedExtension: {
    title:
      'Le estensioni API forniscono una gestione centralizzata delle API, semplificando la configurazione per un facile utilizzo nelle applicazioni di Aiexec.',
  ...
  about: {
    ...
    nowAvailable: 'Aiexec {{version}} è ora disponibile.',
    latestAvailable: 'Aiexec {{version}} è l\'ultima versione disponibile.',
  },
  appMenus: {
