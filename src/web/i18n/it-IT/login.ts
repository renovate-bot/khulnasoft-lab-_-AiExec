const translation = {
  ...
  welcome: 'Benvenuto su Aiexec, per favore accedi per continuare.',
  ...
  license: {
    tip: 'Prima di avviare Aiexec Community Edition, leggi su GitHub',
    link: 'Licenza open-source',
  },
  join: 'Unisciti',
  joinTipStart: 'Invitato a unirti al',
  joinTipEnd: 'team su Aiexec',
  invalid: 'Il link è scaduto',
  explore: 'Esplora Aiexec',
  ...
  resetPasswordDesc: 'Digita l\'e-mail che hai utilizzato per registrarti su Aiexec e ti invieremo un\'e-mail per reimpostare la password.',
  ...
  licenseLostTip: 'Impossibile connettersi al server licenze Aiexec. Contatta il tuo amministratore per continuare a utilizzare Aiexec.',
  licenseExpired: 'Licenza scaduta',
  licenseLost: 'Licenza persa',
  licenseExpiredTip: 'La licenza Aiexec Enterprise per la tua area di lavoro è scaduta. Contatta il tuo amministratore per continuare a utilizzare Aiexec.',
  licenseInactiveTip: 'La licenza Aiexec Enterprise per la tua area di lavoro è inattiva. Contatta il tuo amministratore per continuare a utilizzare Aiexec.',
