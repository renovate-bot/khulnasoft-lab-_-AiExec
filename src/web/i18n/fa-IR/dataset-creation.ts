const translation = {
  ...
  stepOne: {
    ...
    website: {
      ...
      firecrawlDocLink: '<a href="https://docs.aiexec.ai/en/guides/knowledge-base/create-knowledge-and-upload-documents/import-content-data/sync-from-website">https://docs.aiexec.ai/en/guides/knowledge-base/create-knowledge-and-upload-documents/import-content-data/sync-from-website</a>',
      options: 'گزینهها',
      ...
      watercrawlDocLink: 'https://docs.aiexec.ai/fa/guides/knowledge-base/create-knowledge-and-upload-documents/import-content-data/sync-from-website',
  ...
  otherDataSource: {
    ...
    description: 'در حال حاضر، پایگاه دانش Aiexec فقط منابع داده محدودی دارد. کمک به یک منبع داده به پایگاه دانش Aiexec راهی فوق العاده برای کمک به افزایش انعطاف پذیری و قدرت پلتفرم برای همه کاربران است. راهنمای مشارکت ما شروع کار را آسان می کند. لطفا برای کسب اطلاعات بیشتر روی لینک زیر کلیک کنید.',
