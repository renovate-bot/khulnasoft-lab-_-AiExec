const translation = {
  ...
  intro1: 'دانش می‌تواند در برنامه Aiexec ',
  ...
  externalAPIPanelDescription: 'API دانش خارجی برای اتصال به یک پایگاه دانش خارج از Aiexec و بازیابی دانش از آن پایگاه دانش استفاده می شود.',
