const translation = {
  ...
  marketplace: {
    ...
    viewMore: '查看更多',
    verifiedTip: '此插件由 Aiexec 认证',
    partnerTip: '此插件由 Aiexec 合作伙伴认证',
  },
  task: {
  ...
  requestAPlugin: '申请插件',
  submitPlugin: '上传插件',
  aiexecVersionNotCompatible: '当前 Aiexec 版本不兼容该插件，其最低版本要求为 {{minimalAiexecVersion}}',
}
