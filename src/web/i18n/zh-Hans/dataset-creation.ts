const translation = {
  ...
  stepOne: {
    ...
    website: {
      ...
      firecrawlDocLink: 'https://docs.aiexec.ai/zh-hans/guides/knowledge-base/create-knowledge-and-upload-documents/import-content-data/sync-from-website',
  ...
  stepTwo: {
    ...
    click: '前往设置',
    economical: '经济',
    economicalTip: '每个数据块使用 10 个关键词进行检索，不会消耗任何 tokens，但会以降低检索准确性为代价。',
    QATitle: '采用 Q&A 分段模式',
  ...
  otherDataSource: {
    title: '连接到其他数据源？',
    description: '目前，Aiexec 的知识库只有有限的数据源。向 Aiexec 知识库贡献数据源是帮助所有用户增强平台灵活性和强大功能的绝佳方式。我们的贡献指南使入门变得容易。请点击下面的链接了解更多信息。',
    learnMore: '了解更多信息',
  },
}
