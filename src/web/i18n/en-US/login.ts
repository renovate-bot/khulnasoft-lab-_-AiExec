const translation = {
  ...
  welcome: '👋 Welcome to Aiexec, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting Aiexec Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on Aiexec',
  invalid: 'The link has expired',
  explore: 'Explore Aiexec',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on Aiexec and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The Aiexec Enterprise license for your workspace has expired. Please contact your administrator to continue using Aiexec.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect Aiexec license server. Please contact your administrator to continue using Aiexec.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The Aiexec Enterprise license for your workspace is inactive. Please contact your administrator to continue using Aiexec.',
  webapp: {
