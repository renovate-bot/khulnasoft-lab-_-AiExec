const translation = {
  ...
  marketplace: {
    ...
    viewMore: 'View more',
    verifiedTip: 'Verified by Aiexec',
    partnerTip: 'Verified by a Aiexec partner',
  },
  task: {
  ...
  aiexecVersionNotCompatible: 'The current Aiexec version is not compatible with this plugin, please upgrade to the minimum version required: {{minimalAiexecVersion}}',
}
