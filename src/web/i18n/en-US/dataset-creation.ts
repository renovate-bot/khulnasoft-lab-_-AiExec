const translation = {
  ...
  otherDataSource: {
    ...
    description: 'Currently, Aiexec\'s knowledge base only has limited data sources. Contributing a data source to the Aiexec knowledge base is a fantastic way to help enhance the platform\'s flexibility and power for all users. Our contribution guide makes it easy to get started. Please click on the link below to learn more.',
