const translation = {
  ...
  intro1: 'ज्ञान को Aiexec एप्लिकेशन में ',
  ...
  externalTag: 'बाह्य',
  externalAPIPanelDescription: 'बाहरी ज्ञान API का उपयोग Aiexec के बाहर नॉलेज बेस से कनेक्ट करने और उस नॉलेज बेस से ज्ञान प्राप्त करने के लिए किया जाता है।',
