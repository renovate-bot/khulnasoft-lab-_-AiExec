const translation = {
  ...
  marketplace: {
    ...
    and: 'और',
    aiexecMarketplace: 'डिफाई मार्केटप्लेस',
    sortBy: 'काला शहर',
    discover: 'खोजें',
    partnerTip: 'Aiexec भागीदार द्वारा सत्यापित',
  ...
  aiexecVersionNotCompatible: 'वर्तमान डिफाई संस्करण इस प्लगइन के साथ संगत नहीं है, कृपया आवश्यक न्यूनतम संस्करण में अपग्रेड करें: {{minimalAiexecVersion}}',
