const translation = {
  ...
  welcome: 'Bem-vindo ao Aiexec, faça login para continuar.',
  ...
  license: {
    tip: 'Antes de começar a usar a Edição Comunitária do Aiexec, leia a',
    link: 'Licença de código aberto do GitHub',
  },
  join: 'Participar',
  joinTipStart: 'Convidamos você a participar da',
  joinTipEnd: 'equipe no Aiexec',
  invalid: 'O link expirou',
  explore: 'Explorar o Aiexec',
  ...
  resetPasswordDesc: 'Digite o e-mail que você usou para se inscrever no Aiexec e enviaremos um e-mail de redefinição de senha.',
  sendVerificationCode: 'Enviar código de verificação',
  usePassword: 'Usar senha',
  licenseInactiveTip: 'A licença do Aiexec Enterprise para seu espaço de trabalho está inativa. Entre em contato com o administrador para continuar usando o Aiexec.',
  licenseLostTip: 'Falha ao conectar o servidor de licenças Aiexec. Entre em contato com o administrador para continuar usando o Aiexec.',
  licenseExpired: 'Licença expirada',
  licenseLost: 'Licença perdida',
  licenseInactive: 'Licença inativa',
  licenseExpiredTip: 'A licença do Aiexec Enterprise para seu espaço de trabalho expirou. Entre em contato com o administrador para continuar usando o Aiexec.',
  webapp: {
