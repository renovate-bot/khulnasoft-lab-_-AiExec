const translation = {
  ...
  stepOne: {
    ...
    website: {
      ...
      firecrawlDocLink: 'https://docs.aiexec.ai/en/guides/knowledge-base/create-knowledge-and-upload-documents/import-content-data/sync-from-website',
      ...
      watercrawlDocLink: 'https://docs.aiexec.ai/pt/guias/base-de-conhecimentos/criar-conhecimento-e-enviar-documentos/importar-dados-de-conteudo/sincronizar-a-partir-do-site',
  ...
  otherDataSource: {
    ...
    description: 'Atualmente, a base de conhecimento da Aiexec possui apenas fontes de dados limitadas. Contribuir com uma fonte de dados para a base de conhecimento Aiexec é uma maneira fantástica de ajudar a aumentar a flexibilidade e o poder da plataforma para todos os usuários. Nosso guia de contribuição facilita o início. Clique no link abaixo para saber mais.',
