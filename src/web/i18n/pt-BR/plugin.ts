const translation = {
  ...
  marketplace: {
    ...
    aiexecMarketplace: 'Mercado Aiexec',
    moreFrom: 'Mais do Marketplace',
    noPluginFound: 'Nenhum plugin encontrado',
    discover: 'Descobrir',
    verifiedTip: 'Verificado pelo Aiexec',
    partnerTip: 'Verificado por um parceiro da Aiexec',
  },
  task: {
  ...
  aiexecVersionNotCompatible: 'A versão atual do Aiexec não é compatível com este plugin, por favor atualize para a versão mínima exigida: {{minimalAiexecVersion}}',
