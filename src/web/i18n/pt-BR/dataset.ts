const translation = {
  ...
  intro1: 'O Conhecimento pode ser integrado ao aplicativo Aiexec ',
  ...
  externalAPIPanelDescription: 'A API de conhecimento externo é usada para se conectar a uma base de conhecimento fora do Aiexec e recuperar o conhecimento dessa base de conhecimento.',
