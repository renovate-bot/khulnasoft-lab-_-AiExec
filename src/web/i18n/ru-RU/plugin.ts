const translation = {
  ...
  marketplace: {
    ...
    aiexecMarketplace: 'Торговая площадка Aiexec',
    viewMore: 'Подробнее',
    and: 'и',
    discover: 'Обнаруживать',
    verifiedTip: 'Подтверждено Aiexec',
    partnerTip: 'Подтверждено партнером Aiexec',
  },
  task: {
  ...
  aiexecVersionNotCompatible: 'Текущая версия Aiexec не совместима с этим плагином, пожалуйста, обновите до минимально необходимой версии: {{minimalAiexecVersion}}',
