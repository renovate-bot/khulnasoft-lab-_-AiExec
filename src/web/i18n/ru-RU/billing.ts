const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Относится к количеству вызовов API, вызывающих только возможности обработки базы знаний Aiexec.',
    ...
    apiRateLimitTooltip: 'Ограничение скорости API применяется ко всем запросам, сделанным через API Aiexec, включая генерацию текста, чатовую переписку, выполнение рабочих процессов и обработку документов.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        7: 'Обновления и обслуживание от Aiexec официально',
        4: 'ССО',
        ...
        5: 'Согласованные Соглашения об Уровне Услуг от Aiexec Partners',
      },
    ...
    community: {
      features: {
        ...
        2: 'Соблюдает Лицензию на открытое программное обеспечение Aiexec',
      },
      name: 'Сообщество',
