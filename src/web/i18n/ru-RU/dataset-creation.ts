const translation = {
  ...
  stepOne: {
    ...
    website: {
      ...
      watercrawlDocLink: 'https://docs.aiexec.ai/ru/guides/knowledge-base/create-knowledge-and-upload-documents/import-content-data/sync-from-website',
  ...
  otherDataSource: {
    ...
    description: 'В настоящее время база знаний Aiexec имеет лишь ограниченные источники данных. Добавление источника данных в базу знаний Aiexec — это отличный способ повысить гибкость и возможности платформы для всех пользователей. Наше руководство по вкладу поможет вам легко начать работу. Пожалуйста, нажмите на ссылку ниже, чтобы узнать больше.',
  },
  watercrawl: {
