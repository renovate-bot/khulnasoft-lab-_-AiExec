const translation = {
  ...
  marketplace: {
    ...
    sortBy: '黑城',
    viewMore: '查看更多',
    aiexecMarketplace: 'Aiexec 市場',
    pluginsResult: '{{num}} 個結果',
    verifiedTip: '由 Aiexec 驗證',
    partnerTip: '由 Aiexec 合作夥伴驗證',
  },
  task: {
  ...
  aiexecVersionNotCompatible: '當前的 Aiexec 版本與此插件不兼容，請升級至所需的最低版本：{{minimalAiexecVersion}}',
}
