const translation = {
  ...
  marketplace: {
    ...
    aiexecMarketplace: 'ตลาด Aiexec',
    partnerTip: 'ได้รับการตรวจสอบโดยพันธมิตรของ Aiexec',
    verifiedTip: 'ได้รับการตรวจสอบโดย Aiexec',
  },
  task: {
  ...
  aiexecVersionNotCompatible: 'เวอร์ชั่นปัจจุบันของ Aiexec ไม่สามารถใช้งานร่วมกับปลั๊กอินนี้ได้ กรุณาอัปเกรดไปยังเวอร์ชั่นขั้นต่ำที่ต้องการ: {{minimalAiexecVersion}}',
