const translation = {
  ...
  welcome: 'Bienvenue sur Aiexec, veuillez vous connecter pour continuer.',
  ...
  license: {
    tip: 'Avant de commencer Aiexec Community Edition, lisez le GitHub',
    link: 'Licence Open-source',
  },
  join: 'Rejoindre',
  joinTipStart: 'Je vous invite à rejoindre',
  joinTipEnd: 'équipe sur Aiexec',
  invalid: 'Le lien a expiré',
  explore: 'Explorez Aiexec',
  ...
  resetPasswordDesc: 'Tapez l’adresse e-mail que vous avez utilisée pour vous inscrire sur Aiexec et nous vous enverrons un e-mail de réinitialisation de mot de passe.',
  usePassword: 'Utiliser le mot de passe',
  licenseInactiveTip: 'La licence Aiexec Enterprise de votre espace de travail est inactive. Veuillez contacter votre administrateur pour continuer à utiliser Aiexec.',
  licenseLostTip: 'Échec de la connexion au serveur de licences Aiexec. Veuillez contacter votre administrateur pour continuer à utiliser Aiexec.',
  licenseExpired: 'Licence expirée',
  licenseLost: 'Licence perdue',
  licenseExpiredTip: 'La licence Aiexec Enterprise de votre espace de travail a expiré. Veuillez contacter votre administrateur pour continuer à utiliser Aiexec.',
