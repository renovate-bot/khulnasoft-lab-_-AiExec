const translation = {
  ...
  marketplace: {
    ...
    discover: 'Découvrir',
    aiexecMarketplace: 'Marché Aiexec',
    empower: 'Renforcez le développement de votre IA',
    sortBy: 'Ville noire',
    partnerTip: 'Vérifié par un partenaire Aiexec',
    verifiedTip: 'Vérifié par Aiexec',
  },
  task: {
  ...
  aiexecVersionNotCompatible: 'La version actuelle de Aiexec n\'est pas compatible avec ce plugin, veuillez mettre à niveau vers la version minimale requise : {{minimalAiexecVersion}}',
