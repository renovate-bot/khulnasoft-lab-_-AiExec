const translation = {
  ...
  stepOne: {
    ...
    website: {
      ...
      watercrawlDocLink: 'https://docs.aiexec.ai/fr/guide/base-de-connaissances/créer-des-connaissances-et-télécharger-des-documents/importer-des-données-de-contenu/synchroniser-depuis-un-site-web',
  ...
  otherDataSource: {
    ...
    description: 'Actuellement, la base de connaissances de Aiexec ne dispose que de sources de données limitées. Contribuer à une source de données dans la base de connaissances Aiexec est un moyen fantastique d’améliorer la flexibilité et la puissance de la plateforme pour tous les utilisateurs. Notre guide de contribution facilite la prise en main. Veuillez cliquer sur le lien ci-dessous pour en savoir plus.',
