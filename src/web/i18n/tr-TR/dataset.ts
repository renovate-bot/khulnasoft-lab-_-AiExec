const translation = {
  ...
  intro1: 'Bilgi, Aiexec uygulamasına ',
  ...
  externalAPIPanelDescription: 'Harici bilgi API\'si, Aiexec dışındaki bir bilgi bankasına bağlanmak ve bu bilgi bankasından bilgi almak için kullanılır.',
