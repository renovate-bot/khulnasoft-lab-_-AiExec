const translation = {
  ...
  welcome: 'Aiexec\'ye hoş geldiniz, devam etmek için lütfen giriş yapın.',
  ...
  license: {
    tip: 'Aiexec Community Edition\'ı başlatmadan önce GitHub\'daki',
  ...
  resetPasswordDesc: 'Aiexec\'a kaydolmak için kullandığınız e-postayı yazın, size bir şifre sıfırlama e-postası gönderelim.',
  ...
  back: 'Geri',
  licenseExpiredTip: 'Çalışma alanınız için Aiexec Enterprise lisansının süresi doldu. Aiexec\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  licenseLostTip: 'Aiexec lisans sunucusuna bağlanılamadı. Aiexec\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  licenseInactiveTip: 'Çalışma alanınız için Aiexec Enterprise lisansı etkin değil. Aiexec\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
