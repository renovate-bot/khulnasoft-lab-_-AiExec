const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Aiexec\'nin sadece bilgi tabanı işleme yeteneklerini çağıran API çağrıları sayısını ifade eder.',
    ...
    apiRateLimitTooltip: 'Aiexec API\'si aracılığıyla yapılan tüm isteklerde, metin oluşturma, sohbet konuşmaları, iş akışı yürütmeleri ve belge işleme dahil olmak üzere, API Oran Sınırı uygulanır.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        ...
        7: 'Aiexec Tarafından Resmi Güncellemeler ve Bakım',
        5: 'Aiexec Ortakları tarafından müzakere edilen SLA\'lar',
    ...
    community: {
      features: {
        ...
        2: 'Aiexec Açık Kaynak Lisansına uyar',
      },
      price: 'Ücretsiz',
