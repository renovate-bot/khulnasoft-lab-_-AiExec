const translation = {
  ...
  marketplace: {
    ...
    aiexecMarketplace: 'Aiexec Pazar Yeri',
    sortBy: 'Kara şehir',
    moreFrom: 'Marketplace\'ten daha fazlası',
    noPluginFound: 'Eklenti bulunamadı',
    viewMore: 'Daha fazla göster',
    discover: 'Keşfetmek',
    verifiedTip: 'Aiexec tarafından doğrulanmıştır.',
    partnerTip: 'Aiexec partner\'ı tarafından doğrulandı',
  },
  task: {
  ...
  aiexecVersionNotCompatible: 'Mevcut Aiexec sürümü bu eklentiyle uyumlu değil, lütfen gerekli minimum sürüme güncelleyin: {{minimalAiexecVersion}}',
