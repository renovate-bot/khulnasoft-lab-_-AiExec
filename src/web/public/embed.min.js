(()=>{let t="aiexecChatbotConfig",h="aiexec-chatbot-bubble-button",m="aiexec-chatbot-bubble-window",y=window[t],a=!1,l=`
    position: absolute;
    display: flex;
    flex-direction: column;
    justify-content: space-between;
    top: unset;
    right: var(--${h}-right, 1rem); /* Align with aiexec-chatbot-bubble-button. */
    bottom: var(--${h}-bottom, 1rem); /* Align with aiexec-chatbot-bubble-button. */
    left: unset;
    width: 24rem;
