    ...
    return <div className="flex flex-col md:w-[400px]">
      ...
      <div className="mx-auto mt-6 w-full">
        <Button variant='primary' className='w-full !text-sm'>
          <a href="https://aiexec.ai">{t('login.explore')}</a>
        </Button>
      </div>
    </div>
  }
  ...
  return <div className='flex flex-col gap-3'>
    ...
    <div className="system-xs-regular mt-2 block w-full">
      ...
      <Link
        ...
        href={`https://docs.aiexec.ai/${language !== LanguagesSupported[1] ? 'user-agreement' : `v/${locale.toLowerCase()}/policies`}/open-source`}
