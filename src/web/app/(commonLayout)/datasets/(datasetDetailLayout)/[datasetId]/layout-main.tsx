            ...
            <a
              ...
              href={
                locale === LanguagesSupported[1]
                  ? 'https://docs.aiexec.ai/zh-hans/guides/knowledge-base/integrate-knowledge-within-application'
                  : 'https://docs.aiexec.ai/guides/knowledge-base/integrate-knowledge-within-application'
              }
  ...
  return (
    <div className='flex grow overflow-hidden'>
      {!hideSideBar && <AppSideBar
        ...
        icon={datasetRes?.icon || 'https://static.aiexec.ai/images/dataset-default-icon.png'}
