        ...
        <div className='shrink-0 px-3 pb-2 pt-2.5'>
          <div className='radius-2xl relative bg-background-section-burn p-3'>
            ...
            <div className='system-sm-regular mb-4 mt-1 text-text-secondary'>
              ...
              <a target='_blank' rel='noopener noreferrer' className='text-text-accent' href={locale !== LanguagesSupported[1] ? 'https://docs.aiexec.ai/guides/workflow/variables#conversation-variables' : `https://docs.aiexec.ai/${locale.toLowerCase()}/guides/workflow/variables#hui-hua-bian-liang`}>{t('workflow.chatVariable.docLink')}</a>
            </div>
