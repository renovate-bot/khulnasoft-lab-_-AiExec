          ...
          description={<div className='text-xs text-text-tertiary'>
            ...
            <Link href={
              locale === LanguagesSupported[1]
                ? 'https://docs.aiexec.ai/zh-hans/guides/workflow/node/agent#xuan-ze-agent-ce-le'
                : 'https://docs.aiexec.ai/en/guides/workflow/node/agent#select-an-agent-strategy'
