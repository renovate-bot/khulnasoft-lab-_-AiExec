            ...
            <ListEmpty
              ...
              description={<div className='system-xs-regular text-text-tertiary'>
                ...
                <a target='_blank' rel='noopener noreferrer'
                  ...
                  href={locale !== LanguagesSupported[1] ? 'https://docs.aiexec.ai/guides/workflow/variables#conversation-variables' : `https://docs.aiexec.ai/${locale.toLowerCase()}/guides/workflow/variables#hui-hua-bian-liang`}>{t('workflow.variableReference.conversationVars')}</a>
              </div>}
            />
          ))
        : <VarReferenceVars
