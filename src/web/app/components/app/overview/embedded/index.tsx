...
<style>
  #aiexec-chatbot-bubble-button {
    background-color: ${primaryColor} !important;
  }
  #aiexec-chatbot-bubble-window {
...
const Embedded = ({ siteInfo, isShow, onClose, appBaseUrl, accessToken, className }: Props) => {
  ...
  const navigateToChromeUrl = () => {
    window.open('https://chrome.google.com/webstore/detail/aiexec-chatbot/ceehdapohffmjmkdcifjofadiaoeggaf', '_blank', 'noopener,noreferrer')
  }
