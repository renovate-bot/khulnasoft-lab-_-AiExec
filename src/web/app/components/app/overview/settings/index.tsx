              ...
              <div className='w-full'>
                ...
                <p className={cn('body-xs-regular pb-0.5 text-text-tertiary')}>
                  <Trans
                    ...
                    components={{ privacyPolicyLink: <Link href={'https://aiexec.ai/privacy'} target='_blank' rel='noopener noreferrer' className='text-text-accent' /> }}
                  />
                </p>
                <Input
                  className='mt-1'
