...
const Contribute = ({ onRefreshData }: Props) => {
  ...
  const linkUrl = useMemo(() => {
    if (language.startsWith('zh_'))
      return 'https://docs.aiexec.ai/zh-hans/guides/tools#ru-he-chuang-jian-zi-ding-yi-gong-ju'
    return 'https://docs.aiexec.ai/en/guides/tools#how-to-create-custom-tools'
  }, [language])
