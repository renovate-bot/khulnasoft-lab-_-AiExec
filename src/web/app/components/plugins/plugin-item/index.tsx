...
const PluginItem: FC<Props> = ({
  ...
  const isAiexecVersionCompatible = useMemo(() => {
    if (!langeniusVersionInfo.current_version)
      return true
    return gte(langeniusVersionInfo.current_version, declarationMeta.minimum_aiexec_version ?? '0.0.0')
  }, [declarationMeta.minimum_aiexec_version, langeniusVersionInfo.current_version])
        ...
        <div className="flex">
          ...
          <div className="ml-3 w-0 grow">
            <div className="flex h-5 items-center">
              ...
              {!isAiexecVersionCompatible && <Tooltip popupContent={
                t('plugin.aiexecVersionNotCompatible', { minimalAiexecVersion: declarationMeta.minimum_aiexec_version })
