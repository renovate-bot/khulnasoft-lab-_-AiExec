...
import AiexecLogo from '@/app/components/base/logo/aiexec-logo'
        ...
        <div className='flex flex-col items-center gap-4 py-8'>
          {systemFeatures.branding.enabled && systemFeatures.branding.workspace_logo
            ? <img
              ...
              alt='logo'
            />
            : <AiexecLogo size='large' className='mx-auto' />}
          ...
          <div className='flex flex-col items-center gap-2 text-center text-xs font-normal text-text-secondary'>
            ...
            <div className='text-text-accent'>
              {
                IS_CE_EDITION
                  ? <Link href={'https://github.com/langgenius/aiexec/blob/main/LICENSE'} target='_blank' rel='noopener noreferrer'>Open Source License</Link>
                  : <>
                    <Link href='https://aiexec.ai/privacy' target='_blank' rel='noopener noreferrer'>Privacy Policy</Link>,&nbsp;
                    <Link href='https://aiexec.ai/terms' target='_blank' rel='noopener noreferrer'>Terms of Service</Link>
                  </>
              }
            </div>
          </div>
        ...
        <div className='flex items-center justify-between'>
          ...
          <div className='flex items-center'>
            <Button className='mr-2' size='small'>
              <Link
                href={'https://github.com/langgenius/aiexec/releases'}
