      ...
      >
        <div className='flex items-start self-stretch p-4 pb-0'>
          <div className='flex grow flex-col items-start gap-1'>
            ...
            <a className='flex cursor-pointer items-center justify-center gap-1 self-stretch' href='https://docs.aiexec.ai/guides/knowledge-base/external-knowledge-api-documentation' target='_blank'>
