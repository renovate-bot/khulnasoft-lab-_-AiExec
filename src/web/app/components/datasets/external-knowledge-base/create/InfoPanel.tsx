      ...
      <div className='flex w-full min-w-[240px] flex-col items-start gap-3 self-stretch rounded-xl bg-background-section p-6'>
        ...
        <p className='flex flex-col items-start gap-2 self-stretch'>
          ...
          <span className='system-sm-regular text-text-tertiary'>
            ...
            <a className='system-sm-regular ml-1 text-text-accent' href='https://docs.aiexec.ai/en/guides/knowledge-base/external-knowledge-api' target='_blank' rel="noopener noreferrer">
              {t('dataset.connectDatasetIntro.content.link')}
            </a>
            {t('dataset.connectDatasetIntro.content.end')}
          </span>
          <a className='system-sm-regular self-stretch text-text-accent' href='https://docs.aiexec.ai/en/guides/knowledge-base/connect-external-knowledge-base' target='_blank' rel="noopener noreferrer">
