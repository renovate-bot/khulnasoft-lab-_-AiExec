...
import AiexecLogo from '../components/base/logo/aiexec-logo'
...
const EducationApplyAge = () => {
  ...
  const docLink = useMemo(() => {
    if (locale === 'zh-Hans')
      return 'https://docs.aiexec.ai/zh-hans/getting-started/aiexec-for-education'
    if (locale === 'ja-JP')
      return 'https://docs.aiexec.ai/ja-jp/getting-started/aiexec-for-education'
    return 'https://docs.aiexec.ai/getting-started/aiexec-for-education'
  }, [locale])
    ...
    <div className='fixed inset-0 z-[31] overflow-y-auto bg-background-body p-6'>
      <div className='mx-auto w-full max-w-[1408px] rounded-2xl border border-effects-highlight bg-background-default-subtle'>
        ...
        <div className='mt-[-349px] box-content flex h-7 items-center justify-between p-6'>
          <AiexecLogo size='large' style='monochromeWhite' />
        </div>
        <div className='mx-auto max-w-[720px] px-8 pb-[180px]'>
          ...
          <div className='mb-7'>
            ...
            <div className='system-md-regular mb-1 text-text-tertiary'>
              ...
              <a href='https://aiexec.ai/terms' target='_blank' className='text-text-secondary hover:underline'>{t('education.form.terms.desc.termsOfService')}</a>&nbsp;
              {t('education.form.terms.desc.and')}&nbsp;
              <a href='https://aiexec.ai/privacy' target='_blank' className='text-text-secondary hover:underline'>{t('education.form.terms.desc.privacyPolicy')}</a>
