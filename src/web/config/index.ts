...
if (process.env.NEXT_PUBLIC_API_PREFIX && process.env.NEXT_PUBLIC_PUBLIC_API_PREFIX) {
  ...
  // in production env, the host is aiexec.app . In other env, the host is [dev].aiexec.app
...
export const SUPPORT_INSTALL_LOCAL_FILE_EXTENSIONS = '.aiexecpkg,.aiexecbndl'
