...
from aiexec.template.frontend_node.base import FrontendNode
from aiexec.template.template.base import Template

DEFAULT_CUSTOM_COMPONENT_CODE = """from aiexec.custom import CustomComponent

from typing import Optional, List, Dict, Union
from aiexec.field_typing import (
    AgentExecutor,
    BaseChatMemory,
    BaseLanguageModel,
    BaseLLM,
