...
from aiexec.interface.utils import extract_input_variables_from_prompt
...
from aiexec.services.database.models.transactions.crud import log_transaction as crud_log_transaction
from aiexec.services.database.models.transactions.model import TransactionBase
from aiexec.services.database.models.vertex_builds.crud import log_vertex_build as crud_log_vertex_build
from aiexec.services.database.models.vertex_builds.model import VertexBuildBase
...
if TYPE_CHECKING:
    from aiexec.api.v1.schemas import ResultDataResponse
...
def has_chat_output(vertices: dict[Vertex, int]):
    from aiexec.graph.schema import InterfaceComponentTypes
