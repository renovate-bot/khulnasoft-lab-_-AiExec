...
from aiexec.graph.schema import INPUT_COMPONENTS, OUTPUT_COMPONENTS, InterfaceComponentTypes, ResultData
from aiexec.graph.utils import UnbuiltObject, UnbuiltResult, log_transaction
from aiexec.graph.vertex.param_handler import ParameterHandler
from aiexec.interface import initialize
from aiexec.interface.listing import lazy_load_dict
from aiexec.schema.artifact import ArtifactType
from aiexec.schema.data import Data
from aiexec.schema.message import Message
from aiexec.schema.schema import INPUT_FIELD_NAME, OutputValue, build_output_logs
from aiexec.services.deps import get_storage_service
from aiexec.utils.schemas import ChatOutputResponse
from aiexec.utils.util import sync_to_async
...
class Vertex:
    ...
    async def build(
        ...
        **kwargs,
        ...
        from aiexec.interface.components import ensure_component_loaded
