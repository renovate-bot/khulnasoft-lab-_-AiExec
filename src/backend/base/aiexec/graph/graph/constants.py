...
from aiexec.graph.schema import CHAT_COMPONENTS
from aiexec.utils.lazy_load import LazyLoadDictBase

if TYPE_CHECKING:
    from aiexec.graph.vertex.base import Vertex
    from aiexec.graph.vertex.vertex_types import CustomComponentVertex
...
def _import_vertex_types():
    from aiexec.graph.vertex import vertex_types
