...
from aiexec.graph.edge.base import CycleEdge, Edge
from aiexec.graph.graph.constants import Finish, lazy_load_vertex_dict
from aiexec.graph.graph.runnable_vertices_manager import RunnableVerticesManager
from aiexec.graph.graph.schema import GraphData, GraphDump, StartConfigDict, VertexBuildResult
from aiexec.graph.graph.state_manager import GraphStateManager
from aiexec.graph.graph.state_model import create_state_model_from_graph
...
from aiexec.graph.schema import InterfaceComponentTypes, RunOutputs
from aiexec.graph.utils import log_vertex_build
from aiexec.graph.vertex.base import Vertex, VertexStates
from aiexec.graph.vertex.schema import NodeData, NodeTypeEnum
from aiexec.graph.vertex.vertex_types import ComponentVertex, InterfaceVertex, StateVertex
from aiexec.logging.logger import LogConfig, configure
from aiexec.schema.dotdict import dotdict
from aiexec.schema.schema import INPUT_FIELD_NAME, InputType, OutputValue
from aiexec.services.cache.utils import CacheMiss
from aiexec.services.deps import get_chat_service, get_tracing_service
from aiexec.utils.async_helpers import run_until_complete
...
if TYPE_CHECKING:
    ...
    from aiexec.services.chat.schema import GetCache, SetCache
...
class Graph:
    ...
    async def _log_vertex_build_from_exception(self, vertex_id: str, result: Exception) -> None:
        ...
        if isinstance(result, ComponentBuildError):
            ...
            from aiexec.api.utils import format_exception_message
