...
from aiexec.schema.serialize import UUIDstr

if TYPE_CHECKING:
    from aiexec.services.database.models.api_key import ApiKey
    from aiexec.services.database.models.flow import Flow
    from aiexec.services.database.models.folder import Folder
    from aiexec.services.database.models.variable import Variable
