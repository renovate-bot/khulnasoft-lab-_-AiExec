...
from aiexec.services.settings.constants import VARIABLES_TO_GET_FROM_ENVIRONMENT
from aiexec.utils.util_strings import is_valid_database_url
...
class Settings(BaseSettings):
    ...
    def set_dev(cls, value):
        from aiexec.settings import set_dev
