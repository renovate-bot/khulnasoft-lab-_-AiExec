...
from aiexec.services.deps import get_db_service, get_session, get_settings_service
        ...
        if settings_service.auth_settings.AUTO_LOGIN:
            ...
            warnings.warn(
                (
                    ...
                    " or JWT. If you integrated with Aiexec prior to v1.5, make sure to update your code to pass an "
