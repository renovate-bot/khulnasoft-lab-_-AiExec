...
from aiexec.base.tools.constants import (
    TOOL_OUTPUT_DISPLAY_NAME,
    TOOL_OUTPUT_NAME,
    TOOLS_METADATA_INFO,
    TOOLS_METADATA_INPUT_NAME,
)
from aiexec.custom.tree_visitor import RequiredInputsVisitor
from aiexec.exceptions.component import StreamingError
from aiexec.field_typing import Tool  # noqa: TC001 Needed by _add_toolkit_output
from aiexec.graph.state.model import create_state_model
from aiexec.graph.utils import has_chat_output
from aiexec.helpers.custom import format_type
from aiexec.memory import astore_message, aupdate_messages, delete_message
from aiexec.schema.artifact import get_artifact_type, post_process_raw
from aiexec.schema.data import Data
from aiexec.schema.message import ErrorMessage, Message
from aiexec.schema.properties import Source
from aiexec.services.tracing.schema import Log
from aiexec.template.field.base import UNDEFINED, Input, Output
from aiexec.template.frontend_node.custom_components import ComponentFrontendNode
from aiexec.utils.async_helpers import run_until_complete
from aiexec.utils.util import find_closest_match
...
if TYPE_CHECKING:
    ...
    from aiexec.inputs.inputs import InputTypes
...
class Component(CustomComponent):
    ...
    async def _build_tools_metadata_input(self):
        ...
        try:
            from aiexec.io import ToolsInput
        except ImportError as e:
            msg = "Failed to import ToolsInput from aiexec.io"
