...
from aiexec.field_typing.constants import CUSTOM_COMPONENT_SUPPORTED_TYPES, DEFAULT_IMPORT_STRING
...
def get_default_imports(code_string):
    ...
    aiexec_module = importlib.import_module("aiexec.field_typing")
