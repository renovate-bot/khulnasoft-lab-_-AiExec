...
from core.callback_handler.agent_tool_callback_handler import AiexecAgentCallbackHandler
from core.callback_handler.workflow_tool_callback_handler import AiexecWorkflowCallbackHandler
...
class ToolEngine:
    ...
    def agent_invoke(
        ...
        agent_tool_callback: AiexecAgentCallbackHandler,
    ...
    def generic_invoke(
        ...
        user_id: str,
        workflow_tool_callback: AiexecWorkflowCallbackHandler,
