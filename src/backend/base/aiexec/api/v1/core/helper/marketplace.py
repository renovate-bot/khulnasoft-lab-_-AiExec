...
marketplace_api_url = URL(str(aiexec_config.MARKETPLACE_API_URL))
...
def download_plugin_pkg(plugin_unique_identifier: str):
    return download_with_size_limit(get_plugin_pkg_url(plugin_unique_identifier), aiexec_config.PLUGIN_MAX_PACKAGE_SIZE)
