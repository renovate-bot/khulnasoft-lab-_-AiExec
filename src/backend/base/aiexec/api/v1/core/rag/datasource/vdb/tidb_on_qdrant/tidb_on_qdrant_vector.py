    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> TidbOnQdrantVector:
                ...
                if tidb_auth_binding:
                    ...
                    if idle_tidb_auth_binding:
                        ...
                        new_cluster = TidbService.create_tidb_serverless_cluster(
                            aiexec_config.TIDB_PROJECT_ID or "",
                            aiexec_config.TIDB_API_URL or "",
                            aiexec_config.TIDB_IAM_API_URL or "",
                            aiexec_config.TIDB_PUBLIC_KEY or "",
                            aiexec_config.TIDB_PRIVATE_KEY or "",
                            aiexec_config.TIDB_REGION or "",
                        )
        ...
        return TidbOnQdrantVector(
            ...
            config=TidbOnQdrantConfig(
                endpoint=aiexec_config.TIDB_ON_QDRANT_URL or "",
                api_key=TIDB_ON_QDRANT_API_KEY,
                root_path=str(config.root_path),
                timeout=aiexec_config.TIDB_ON_QDRANT_CLIENT_TIMEOUT,
                grpc_port=aiexec_config.TIDB_ON_QDRANT_GRPC_PORT,
                prefer_grpc=aiexec_config.TIDB_ON_QDRANT_GRPC_ENABLED,
                replication_factor=aiexec_config.QDRANT_REPLICATION_FACTOR,
            ),
        )
