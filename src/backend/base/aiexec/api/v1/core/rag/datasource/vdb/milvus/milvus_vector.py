...
class MilvusVectorFactory(AbstractVectorFactory):
    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> MilvusVector:
        ...
        return MilvusVector(
            ...
            config=MilvusConfig(
                uri=aiexec_config.MILVUS_URI or "",
                token=aiexec_config.MILVUS_TOKEN or "",
                user=aiexec_config.MILVUS_USER or "",
                password=aiexec_config.MILVUS_PASSWORD or "",
                database=aiexec_config.MILVUS_DATABASE or "",
                enable_hybrid_search=aiexec_config.MILVUS_ENABLE_HYBRID_SEARCH or False,
                analyzer_params=aiexec_config.MILVUS_ANALYZER_PARAMS or "",
            ),
        )
