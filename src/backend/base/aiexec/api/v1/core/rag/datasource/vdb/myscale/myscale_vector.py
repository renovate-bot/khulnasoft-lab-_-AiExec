    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> MyScaleVector:
        ...
        return MyScaleVector(
            ...
            config=MyScaleConfig(
                host=aiexec_config.MYSCALE_HOST,
                port=aiexec_config.MYSCALE_PORT,
                user=aiexec_config.MYSCALE_USER,
                password=aiexec_config.MYSCALE_PASSWORD,
                database=aiexec_config.MYSCALE_DATABASE,
                fts_params=aiexec_config.MYSCALE_FTS_PARAMS,
            ),
        )
