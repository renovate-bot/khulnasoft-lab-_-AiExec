    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> TableStoreVector:
        ...
        return TableStoreVector(
            ...
            config=TableStoreConfig(
                endpoint=aiexec_config.TABLESTORE_ENDPOINT,
                instance_name=aiexec_config.TABLESTORE_INSTANCE_NAME,
                access_key_id=aiexec_config.TABLESTORE_ACCESS_KEY_ID,
                access_key_secret=aiexec_config.TABLESTORE_ACCESS_KEY_SECRET,
            ),
        )
