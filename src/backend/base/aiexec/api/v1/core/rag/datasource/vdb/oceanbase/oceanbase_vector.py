    ...
    def init_vector(
        ...
        return OceanBaseVector(
            ...
            OceanBaseVectorConfig(
                host=aiexec_config.OCEANBASE_VECTOR_HOST or "",
                port=aiexec_config.OCEANBASE_VECTOR_PORT or 0,
                user=aiexec_config.OCEANBASE_VECTOR_USER or "",
                password=(aiexec_config.OCEANBASE_VECTOR_PASSWORD or ""),
                database=aiexec_config.OCEANBASE_VECTOR_DATABASE or "",
                enable_hybrid_search=aiexec_config.OCEANBASE_ENABLE_HYBRID_SEARCH or False,
            ),
        )
