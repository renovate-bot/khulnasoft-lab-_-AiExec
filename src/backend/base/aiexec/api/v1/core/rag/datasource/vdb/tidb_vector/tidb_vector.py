    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> TiDBVector:
        ...
        return TiDBVector(
            ...
            config=TiDBVectorConfig(
                host=aiexec_config.TIDB_VECTOR_HOST or "",
                port=aiexec_config.TIDB_VECTOR_PORT or 0,
                user=aiexec_config.TIDB_VECTOR_USER or "",
                password=aiexec_config.TIDB_VECTOR_PASSWORD or "",
                database=aiexec_config.TIDB_VECTOR_DATABASE or "",
                program_name=aiexec_config.APPLICATION_NAME,
            ),
        )
