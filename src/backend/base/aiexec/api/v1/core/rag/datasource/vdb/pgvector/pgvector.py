    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> PGVector:
        ...
        return PGVector(
            ...
            config=PGVectorConfig(
                host=aiexec_config.PGVECTOR_HOST or "localhost",
                port=aiexec_config.PGVECTOR_PORT,
                user=aiexec_config.PGVECTOR_USER or "postgres",
                password=aiexec_config.PGVECTOR_PASSWORD or "",
                database=aiexec_config.PGVECTOR_DATABASE or "postgres",
                min_connection=aiexec_config.PGVECTOR_MIN_CONNECTION,
                max_connection=aiexec_config.PGVECTOR_MAX_CONNECTION,
                pg_bigm=aiexec_config.PGVECTOR_PG_BIGM,
            ),
        )
