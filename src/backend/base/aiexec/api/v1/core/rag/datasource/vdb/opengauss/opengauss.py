    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> OpenGauss:
        ...
        return OpenGauss(
            ...
            config=OpenGaussConfig(
                host=aiexec_config.OPENGAUSS_HOST or "localhost",
                port=aiexec_config.OPENGAUSS_PORT,
                user=aiexec_config.OPENGAUSS_USER or "postgres",
                password=aiexec_config.OPENGAUSS_PASSWORD or "",
                database=aiexec_config.OPENGAUSS_DATABASE or "aiexec",
                min_connection=aiexec_config.OPENGAUSS_MIN_CONNECTION,
                max_connection=aiexec_config.OPENGAUSS_MAX_CONNECTION,
                enable_pq=aiexec_config.OPENGAUSS_ENABLE_PQ or False,
            ),
        )
