...
class ChromaVectorFactory(AbstractVectorFactory):
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> BaseVector:
        ...
        return ChromaVector(
            ...
            config=ChromaConfig(
                host=aiexec_config.CHROMA_HOST or "",
                port=aiexec_config.CHROMA_PORT,
                tenant=aiexec_config.CHROMA_TENANT or chromadb.DEFAULT_TENANT,
                database=aiexec_config.CHROMA_DATABASE or chromadb.DEFAULT_DATABASE,
                auth_provider=aiexec_config.CHROMA_AUTH_PROVIDER,
                auth_credentials=aiexec_config.CHROMA_AUTH_CREDENTIALS,
            ),
        )
