...
class Executor:
    ...
    def __init__(
        ...
        *,
        ...
        max_retries: int = aiexec_config.SSRF_DEFAULT_MAX_RETRIES,
    ):
    ...
    def _validate_and_parse_response(self, response: httpx.Response) -> Response:
        ...
        threshold_size = (
            aiexec_config.HTTP_REQUEST_NODE_MAX_BINARY_SIZE
            if executor_response.is_file
            else aiexec_config.HTTP_REQUEST_NODE_MAX_TEXT_SIZE
        )
