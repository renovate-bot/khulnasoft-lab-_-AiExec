...
HTTP_REQUEST_DEFAULT_TIMEOUT = HttpRequestNodeTimeout(
    connect=aiexec_config.HTTP_REQUEST_MAX_CONNECT_TIMEOUT,
    read=aiexec_config.HTTP_REQUEST_MAX_READ_TIMEOUT,
    write=aiexec_config.HTTP_REQUEST_MAX_WRITE_TIMEOUT,
)
            ...
            "config": {
                ...
                "timeout": {
                    **HTTP_REQUEST_DEFAULT_TIMEOUT.model_dump(),
                    "max_connect_timeout": aiexec_config.HTTP_REQUEST_MAX_CONNECT_TIMEOUT,
                    "max_read_timeout": aiexec_config.HTTP_REQUEST_MAX_READ_TIMEOUT,
                    "max_write_timeout": aiexec_config.HTTP_REQUEST_MAX_WRITE_TIMEOUT,
                },
                "ssl_verify": aiexec_config.HTTP_REQUEST_NODE_SSL_VERIFY,
            },
            "retry_config": {
                "max_retries": aiexec_config.SSRF_DEFAULT_MAX_RETRIES,
