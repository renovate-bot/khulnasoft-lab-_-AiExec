...
class HttpRequestNodeTimeout(BaseModel):
    connect: int = aiexec_config.HTTP_REQUEST_MAX_CONNECT_TIMEOUT
    read: int = aiexec_config.HTTP_REQUEST_MAX_READ_TIMEOUT
    write: int = aiexec_config.HTTP_REQUEST_MAX_WRITE_TIMEOUT
...
class HttpRequestNodeData(BaseNodeData):
    ...
    ssl_verify: Optional[bool] = aiexec_config.HTTP_REQUEST_NODE_SSL_VERIFY
