...
class AlreadySetupError(BaseHTTPException):
    ...
    description = "Aiexec has been successfully installed. Please refresh the page or return to the dashboard homepage."
    code = 403
...
class NotSetupError(BaseHTTPException):
    ...
    description = (
        "Aiexec has not been initialized and installed yet. "
