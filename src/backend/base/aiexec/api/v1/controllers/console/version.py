...
class VersionApi(Resource):
    def get(self):
        ...
        check_update_url = aiexec_config.CHECK_UPDATE_URL

        result = {
            "version": aiexec_config.CURRENT_VERSION,
            "release_date": "",
            "release_notes": "",
            "can_auto_update": False,
            "features": {
                "can_replace_logo": aiexec_config.CAN_REPLACE_LOGO,
                "model_load_balancing_enabled": aiexec_config.MODEL_LB_ENABLED,
            },
        }
