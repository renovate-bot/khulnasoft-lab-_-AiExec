...
class AppGenerateService:
    system_rate_limiter = RateLimiter("app_daily_rate_limiter", aiexec_config.APP_DAILY_RATE_LIMIT, 86400)
    ...
    def generate(
        ...
        if aiexec_config.BILLING_ENABLED:
            ...
            if limit_info["subscription"]["plan"] == "sandbox":
                if cls.system_rate_limiter.is_rate_limited(app_model.tenant_id):
                    raise InvokeRateLimitError(
                        ...
                        f"or your RPD was {aiexec_config.APP_DAILY_RATE_LIMIT} requests/day"
                    )
    ...
    def _get_max_active_requests(app_model: App) -> int:
        ...
        if max_active_requests is None:
            max_active_requests = int(aiexec_config.APP_MAX_ACTIVE_REQUESTS)
