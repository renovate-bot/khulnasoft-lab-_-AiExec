...
def test_run():
    ...
    pool = VariablePool(
        system_variables={
            SystemVariableKey.QUERY: "aiexec",
    ...
    pool.add(["pe", "list_output"], ["aiexec-1", "aiexec-2"])
    ...
    def tt_generator(self):
        return NodeRunResult(
            ...
            inputs={"iterator_selector": "aiexec"},
            outputs={"output": "aiexec 123"},
        )
    ...
    with patch.object(TemplateTransformNode, "_run", new=tt_generator):
        ...
        for item in result:
            ...
            if isinstance(item, RunCompletedEvent):
                ...
                assert item.run_result.outputs == {"output": ["aiexec 123", "aiexec 123"]}
