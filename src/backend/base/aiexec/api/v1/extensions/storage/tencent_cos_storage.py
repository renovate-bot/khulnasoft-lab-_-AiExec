...
class TencentCosStorage(BaseStorage):
    ...
    def __init__(self):
        ...
        self.bucket_name = aiexec_config.TENCENT_COS_BUCKET_NAME
        config = CosConfig(
            Region=aiexec_config.TENCENT_COS_REGION,
            SecretId=aiexec_config.TENCENT_COS_SECRET_ID,
            SecretKey=aiexec_config.TENCENT_COS_SECRET_KEY,
            Scheme=aiexec_config.TENCENT_COS_SCHEME,
        )
