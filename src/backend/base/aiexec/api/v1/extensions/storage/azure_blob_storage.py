...
class AzureBlobStorage(BaseStorage):
    ...
    def __init__(self):
        super().__init__()
        self.bucket_name = aiexec_config.AZURE_BLOB_CONTAINER_NAME
        self.account_url = aiexec_config.AZURE_BLOB_ACCOUNT_URL
        self.account_name = aiexec_config.AZURE_BLOB_ACCOUNT_NAME
        self.account_key = aiexec_config.AZURE_BLOB_ACCOUNT_KEY
