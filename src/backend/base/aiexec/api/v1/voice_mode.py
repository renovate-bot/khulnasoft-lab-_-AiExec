...
from aiexec.services.database.models import MessageTable, User
                ...
                try:
                    while True:
                        ...
                        if event.get("type") == "input_audio_buffer.append":
                            ...
                            logger.info(f"aiexec.elevenlabs.config {event}")
