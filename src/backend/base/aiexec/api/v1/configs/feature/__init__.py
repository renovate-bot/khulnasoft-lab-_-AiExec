...
class MarketplaceConfig(BaseSettings):
    ...
    MARKETPLACE_API_URL: HttpUrl = Field(
        ...
        default=HttpUrl("https://marketplace.aiexec.ai"),
    )
...
class UpdateConfig(BaseSettings):
    ...
    CHECK_UPDATE_URL: str = Field(
        ...
        default="https://updates.aiexec.ai",
    )
...
class RagEtlConfig(BaseSettings):
    ...
    ETL_TYPE: str = Field(
        description="RAG ETL type ('aiexec' or 'Unstructured'), default to 'aiexec'",
        default="aiexec",
    )
