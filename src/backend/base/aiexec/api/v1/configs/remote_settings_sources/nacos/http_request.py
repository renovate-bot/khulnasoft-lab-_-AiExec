...
class NacosHttpClient:
    def __init__(self):
        self.username = os.getenv("AIEXEC_ENV_NACOS_USERNAME")
        self.password = os.getenv("AIEXEC_ENV_NACOS_PASSWORD")
        self.ak = os.getenv("AIEXEC_ENV_NACOS_ACCESS_KEY")
        self.sk = os.getenv("AIEXEC_ENV_NACOS_SECRET_KEY")
        self.server = os.getenv("AIEXEC_ENV_NACOS_SERVER_ADDR", "localhost:8848")
        self.token = None
    ...
    def _inject_auth_info(self, headers, params, module="config"):
        headers.update({"User-Agent": "Nacos-Http-Client-In-Aiexec:v0.0.1"})
