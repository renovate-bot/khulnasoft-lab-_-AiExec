...
from aiexec.base.prompts.utils import dict_values_to_string
from aiexec.schema.content_block import ContentBlock
from aiexec.schema.content_types import ErrorContent
from aiexec.schema.data import Data
from aiexec.schema.image import Image, get_file_paths, is_image_file
from aiexec.schema.properties import Properties, Source
from aiexec.schema.validators import timestamp_to_str, timestamp_to_str_validator
...
from aiexec.utils.image import create_data_url
...
class Message(Data):
    ...
    def to_dataframe(self) -> DataFrame:
        from aiexec.schema.dataframe import DataFrame  # Local import to avoid circular import
