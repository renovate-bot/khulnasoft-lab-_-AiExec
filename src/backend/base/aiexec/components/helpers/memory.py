...
from aiexec.helpers.data import data_to_text
from aiexec.inputs import HandleInput
from aiexec.io import DropdownInput, IntInput, MessageTextInput, MultilineInput, Output
...
class MemoryComponent(Component):
    ...
    description = "Retrieves stored chat messages from Aiexec tables or an external memory."
