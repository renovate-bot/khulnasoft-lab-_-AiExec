...
from aiexec.inputs import DropdownInput, TableInput
from aiexec.inputs.inputs import InputTypes
from aiexec.io import MessageTextInput, MultilineInput, Output, TabInput
from aiexec.io.schema import flatten_schema, schema_to_aiexec_inputs
        ...
        try:
            ...
            if mode == "Stdio":
                ...
                try:
                    ...
                    msg = f"Invalid SSE URL configuration: {e}. Please check your Aiexec deployment URL and port."
                    raise ValueError(msg) from e
                except ConnectionError as e:
                    # Connection failed after retries
                    logger.error(f"SSE connection error: {e}")
                    msg = (
                        f"Could not connect to Aiexec SSE endpoint: {e}. "
                        "Please verify:\n"
                        "1. Aiexec server is running\n"
                        "2. The SSE URL matches your Aiexec deployment port\n"
