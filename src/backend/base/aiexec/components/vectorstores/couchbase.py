...
from aiexec.base.vectorstores.model import LCVectorStoreComponent, check_cached_vector_store
from aiexec.helpers.data import docs_to_data
from aiexec.io import HandleInput, IntInput, SecretStrInput, StrInput
...
class CouchbaseVectorStoreComponent(LCVectorStoreComponent):
    ...
    def build_vector_store(self) -> CouchbaseVectorStore:
        try:
            ...
            msg = "Failed to import Couchbase dependencies. Install it using `pip install aiexec[couchbase] --pre`"
