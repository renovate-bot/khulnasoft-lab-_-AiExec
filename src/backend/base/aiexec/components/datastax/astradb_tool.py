...
from aiexec.io import BoolInput, DictInput, HandleInput, IntInput, SecretStrInput, StrInput, TableInput
...
class AstraDBToolComponent(LCToolComponent):
    ...
    documentation: str = "https://docs.aiexec.org/Components/components-tools#astra-db-tool"
    icon: str = "AstraDB"
