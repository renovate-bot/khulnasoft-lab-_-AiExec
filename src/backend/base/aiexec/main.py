...
from aiexec.logging.logger import configure
...
from aiexec.services.utils import initialize_services, teardown_services
...
def get_lifespan(*, fix_migration=False, version=None):
    ...
    async def lifespan(_app: FastAPI):
        ...
        # Startup message
        if version:
            logger.debug(f"Starting Aiexec v{version}...")
        else:
            logger.debug("Starting Aiexec...")
        ...
        try:
            ...
            # Final message
            logger.debug("Aiexec shutdown complete")
