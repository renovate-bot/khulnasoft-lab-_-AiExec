...
class NacosSettingsSource(RemoteSettingsSource):
    ...
    def async_init(self):
        data_id = os.getenv("AIEXEC_ENV_NACOS_DATA_ID", "aiexec-api-env.properties")
        group = os.getenv("AIEXEC_ENV_NACOS_GROUP", "nacos-aiexec")
        tenant = os.getenv("AIEXEC_ENV_NACOS_NAMESPACE", "")
