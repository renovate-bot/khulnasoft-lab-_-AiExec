    ...
    def get(self):
        ...
        try:
            return {
                ...
                "host": aiexec_config.PLUGIN_REMOTE_INSTALL_HOST,
                "port": aiexec_config.PLUGIN_REMOTE_INSTALL_PORT,
            }
...
class PluginIconApi(Resource):
    ...
    def get(self):
        ...
        icon_cache_max_age = aiexec_config.TOOL_ICON_CACHE_MAX_AGE
...
class PluginUploadFromPkgApi(Resource):
    ...
    def post(self):
        ...
        # check file size
        if file.content_length > aiexec_config.PLUGIN_MAX_PACKAGE_SIZE:
...
class PluginUploadFromBundleApi(Resource):
    ...
    def post(self):
        ...
        # check file size
        if file.content_length > aiexec_config.PLUGIN_MAX_BUNDLE_SIZE:
            raise ValueError("File size exceeds the maximum allowed size")
