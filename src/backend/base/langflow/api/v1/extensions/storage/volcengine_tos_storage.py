...
class VolcengineTosStorage(BaseStorage):
    ...
    def __init__(self):
        super().__init__()
        self.bucket_name = aiexec_config.VOLCENGINE_TOS_BUCKET_NAME
        self.client = tos.TosClientV2(
            ak=aiexec_config.VOLCENGINE_TOS_ACCESS_KEY,
            sk=aiexec_config.VOLCENGINE_TOS_SECRET_KEY,
            endpoint=aiexec_config.VOLCENGINE_TOS_ENDPOINT,
            region=aiexec_config.VOLCENGINE_TOS_REGION,
        )
