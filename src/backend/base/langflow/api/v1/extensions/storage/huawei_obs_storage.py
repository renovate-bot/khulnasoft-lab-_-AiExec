...
class HuaweiObsStorage(BaseStorage):
    ...
    def __init__(self):
        ...
        self.bucket_name = aiexec_config.HUAWEI_OBS_BUCKET_NAME
        self.client = ObsClient(
            access_key_id=aiexec_config.HUAWEI_OBS_ACCESS_KEY,
            secret_access_key=aiexec_config.HUAWEI_OBS_SECRET_KEY,
            server=aiexec_config.HUAWEI_OBS_SERVER,
        )
