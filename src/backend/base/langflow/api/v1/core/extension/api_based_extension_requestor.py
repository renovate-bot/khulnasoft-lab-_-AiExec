...
class APIBasedExtensionRequestor:
    ...
    def request(self, point: APIBasedExtensionPoint, params: dict) -> dict:
        ...
        try:
            ...
            proxies = None
            if aiexec_config.SSRF_PROXY_HTTP_URL and aiexec_config.SSRF_PROXY_HTTPS_URL:
                proxies = {
                    "http": aiexec_config.SSRF_PROXY_HTTP_URL,
                    "https": aiexec_config.SSRF_PROXY_HTTPS_URL,
                }
