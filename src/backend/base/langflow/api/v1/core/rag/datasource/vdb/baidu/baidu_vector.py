...
class BaiduVectorFactory(AbstractVectorFactory):
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> BaiduVector:
        ...
        return BaiduVector(
            ...
            config=BaiduConfig(
                endpoint=aiexec_config.BAIDU_VECTOR_DB_ENDPOINT or "",
                connection_timeout_in_mills=aiexec_config.BAIDU_VECTOR_DB_CONNECTION_TIMEOUT_MS,
                account=aiexec_config.BAIDU_VECTOR_DB_ACCOUNT or "",
                api_key=aiexec_config.BAIDU_VECTOR_DB_API_KEY or "",
                database=aiexec_config.BAIDU_VECTOR_DB_DATABASE or "",
                shard=aiexec_config.BAIDU_VECTOR_DB_SHARD,
                replicas=aiexec_config.BAIDU_VECTOR_DB_REPLICAS,
            ),
        )
