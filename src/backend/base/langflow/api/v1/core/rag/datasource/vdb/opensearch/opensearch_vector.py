...
class OpenSearchVectorFactory(AbstractVectorFactory):
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> OpenSearchVector:
        ...
        open_search_config = OpenSearchConfig(
            host=aiexec_config.OPENSEARCH_HOST or "localhost",
            port=aiexec_config.OPENSEARCH_PORT,
            secure=aiexec_config.OPENSEARCH_SECURE,
            verify_certs=aiexec_config.OPENSEARCH_VERIFY_CERTS,
            auth_method=aiexec_config.OPENSEARCH_AUTH_METHOD.value,
            user=aiexec_config.OPENSEARCH_USER,
            password=aiexec_config.OPENSEARCH_PASSWORD,
            aws_region=aiexec_config.OPENSEARCH_AWS_REGION,
            aws_service=aiexec_config.OPENSEARCH_AWS_SERVICE,
        )
