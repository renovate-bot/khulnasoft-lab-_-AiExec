    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> OracleVector:
        ...
        return OracleVector(
            ...
            config=OracleVectorConfig(
                user=aiexec_config.ORACLE_USER or "system",
                password=aiexec_config.ORACLE_PASSWORD or "oracle",
                dsn=aiexec_config.ORACLE_DSN or "oracle:1521/freepdb1",
                config_dir=aiexec_config.ORACLE_CONFIG_DIR,
                wallet_location=aiexec_config.ORACLE_WALLET_LOCATION,
                wallet_password=aiexec_config.ORACLE_WALLET_PASSWORD,
                is_autonomous=aiexec_config.ORACLE_IS_AUTONOMOUS,
            ),
        )
