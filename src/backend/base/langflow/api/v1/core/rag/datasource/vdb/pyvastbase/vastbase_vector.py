    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> VastbaseVector:
        ...
        return VastbaseVector(
            ...
            config=VastbaseVectorConfig(
                host=aiexec_config.VASTBASE_HOST or "localhost",
                port=aiexec_config.VASTBASE_PORT,
                user=aiexec_config.VASTBASE_USER or "aiexec",
                password=aiexec_config.VASTBASE_PASSWORD or "",
                database=aiexec_config.VASTBASE_DATABASE or "aiexec",
                min_connection=aiexec_config.VASTBASE_MIN_CONNECTION,
                max_connection=aiexec_config.VASTBASE_MAX_CONNECTION,
            ),
        )
