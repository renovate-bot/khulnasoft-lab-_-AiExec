    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> TencentVector:
        ...
        return TencentVector(
            ...
            config=TencentConfig(
                url=aiexec_config.TENCENT_VECTOR_DB_URL or "",
                api_key=aiexec_config.TENCENT_VECTOR_DB_API_KEY,
                timeout=aiexec_config.TENCENT_VECTOR_DB_TIMEOUT,
                username=aiexec_config.TENCENT_VECTOR_DB_USERNAME,
                database=aiexec_config.TENCENT_VECTOR_DB_DATABASE,
                shard=aiexec_config.TENCENT_VECTOR_DB_SHARD,
                replicas=aiexec_config.TENCENT_VECTOR_DB_REPLICAS,
                enable_hybrid_search=aiexec_config.TENCENT_VECTOR_DB_ENABLE_HYBRID_SEARCH or False,
            ),
        )
