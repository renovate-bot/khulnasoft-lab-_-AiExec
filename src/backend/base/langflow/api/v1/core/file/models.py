...
class File(BaseModel):
    # NOTE: aiexec_model_identity is a special identifier used to distinguish between
    # new and old data formats during serialization and deserialization.
    aiexec_model_identity: str = FILE_MODEL_IDENTITY
    ...
    def __init__(
        ...
        *,
        ...
        aiexec_model_identity: Optional[str] = FILE_MODEL_IDENTITY,
        ...
        super().__init__(
            ...
            mime_type=mime_type,
            size=size,
            aiexec_model_identity=aiexec_model_identity,
            url=url,
        )
    ...
    def to_plugin_parameter(self) -> dict[str, Any]:
        return {
            "aiexec_model_identity": FILE_MODEL_IDENTITY,
