...
class IterationNode(BaseNode[IterationNodeData]):
    ...
    def _run(self) -> Generator[NodeEvent | InNodeEvent, None, None]:
        ...
        graph_engine = GraphEngine(
            ...
            max_execution_steps=aiexec_config.WORKFLOW_MAX_EXECUTION_STEPS,
            max_execution_time=aiexec_config.WORKFLOW_MAX_EXECUTION_TIME,
        ...
        try:
            if self.node_data.is_parallel:
                ...
                thread_pool = GraphEngineThreadPool(
                    max_workers=self.node_data.parallel_nums, max_submit_count=aiexec_config.MAX_SUBMIT_COUNT
                )
