...
from aiexec.components.languagemodels.ollama import ChatOllamaComponent
...
class TestChatOllamaComponent(ComponentTestBaseWithoutClient):
    ...
    @patch("aiexec.components.languagemodels.ollama.ChatOllama")
    ...
    @pytest.mark.asyncio
    @patch("aiexec.components.languagemodels.ollama.httpx.AsyncClient.post")
    @patch("aiexec.components.languagemodels.ollama.httpx.AsyncClient.get")
