...
class TestStructuredOutputComponent(ComponentTestBaseWithoutClient):
    ...
    def test_successful_structured_output_generation_with_patch_with_config(self):
        ...
        with patch("aiexec.components.processing.structured_output.get_chat_result", mock_get_chat_result):
    ...
    @patch("aiexec.components.processing.structured_output.get_chat_result")
