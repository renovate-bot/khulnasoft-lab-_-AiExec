...
import pytest
from aiexec.components.youtube.youtube_transcripts import YouTubeTranscriptsComponent
from aiexec.schema import Data, DataFrame, Message
...
class TestYouTubeTranscriptsComponent(ComponentTestBaseWithoutClient):
    ...
    @patch("aiexec.components.youtube.youtube_transcripts.YoutubeLoader")
