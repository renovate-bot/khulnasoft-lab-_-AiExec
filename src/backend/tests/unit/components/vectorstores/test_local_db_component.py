...
import pytest
from aiexec.components.vectorstores.local_db import LocalDBComponent
...
class TestLocalDBComponent(ComponentTestBaseWithoutClient):
    ...
    def default_kwargs(self, tmp_path: Path) -> dict[str, Any]:
        ...
        from aiexec.components.embeddings.openai import OpenAIEmbeddingsComponent
    ...
    @patch("aiexec.components.vectorstores.local_db.LocalDBComponent.list_existing_collections")
