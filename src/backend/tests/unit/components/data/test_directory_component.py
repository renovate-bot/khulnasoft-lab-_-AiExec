...
import pytest
from aiexec.components.data import DirectoryComponent
...
class TestDirectoryComponent(ComponentTestBaseWithoutClient):
    ...
    @patch("aiexec.components.data.directory.parallel_load_data")
    @patch("aiexec.components.data.directory.retrieve_file_paths")
    @patch("aiexec.components.data.DirectoryComponent.resolve_path")
