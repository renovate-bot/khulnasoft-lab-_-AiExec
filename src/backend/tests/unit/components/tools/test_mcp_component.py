...
import pytest
from aiexec.components.data.mcp_component import MCPSseClient, MCPStdioClient, MCPToolsComponent
...
class TestMCPToolsComponent(ComponentTestBaseWithoutClient):
    ...
    @patch("aiexec.components.data.mcp_component.create_tool_coroutine")
