...
test(
  ...
  async ({ page }) => {
    ...
    newCode = newCode.replace(
      `from aiexec.inputs import BoolInput, DictInput, DropdownInput, IntInput, SecretStrInput, SliderInput, StrInput`,
      `from aiexec.inputs import BoolInput, DictInput, DropdownInput, IntInput, SecretStrInput, SliderInput, StrInput, QueryInput`,
    );
