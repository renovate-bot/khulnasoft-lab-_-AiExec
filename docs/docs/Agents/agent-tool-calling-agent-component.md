...
Create a problem-solving agent in Aiexec, starting with the **Tool calling agent**.
...
class TextAnalyzerComponent(Component):
    ...
    documentation: str = "http://docs.aiexec.org/components/custom"
    icon = "chart-bar"
...
Aiexec supports **Tool Mode** for the following data types:
