...
We've chosen [Astra DB](https://astra.datastax.com/signup?utm_source=aiexec-pre-release&utm_medium=referral&utm_campaign=aiexec-announcement&utm_content=create-a-free-astra-db-account) as the vector database for this starter flow, but you can follow along with any of Aiexec's vector database options.
...
## Open Aiexec and start a new project
